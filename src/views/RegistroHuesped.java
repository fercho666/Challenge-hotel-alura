...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] {"Afgano", "Alemania", "Arabia", "Argentina", "Australia", "Belgica", "Bolivia", "Brasil", "Camboya", "Canada", "Chile", "China", "Colombia", "Corea", "Costa Rica", "Cuba", "Dinamarca", "Ecuador", "Egipto", "Salvador", "Escoia", "España",  "Estonia", "Etiopia", "Filipinas", "Finlandia", "Francia", "Reino Unido", "Grecia", "Guatemala", "Haiti", "Holanda", "Honduras", "Indonesia","Inglaterra", "IraK", "Iran", "Irlanda", "Israel", "Italia", "Japon", "Jordania", "Laos", "Letonia", "Malasia", "Marroecos", "Mexico", "Nicaragüa", "Noruega", "Puert Rico", "Republica Dominicana", "Rumania", "Rusia", "Suecia", "Suiza", "Tailandia", "Taiwana", "Turquia", "Ucrania", "Uruguay", "Venezuela", "Vietnam"}));
		...
		JLabel lblNacionalidad = new JLabel(" PAIS DE PROCEDENCIA ");
